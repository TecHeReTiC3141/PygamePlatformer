...
<tileset version="1.8" tiledversion="1.8.4" name="terrain_edges" tilewidth="128" tileheight="128" tilecount="20" columns="10">
 <image source="terrain_edges.png" width="1280" height="256"/>
 <wangsets>
  <wangset name="Edge Terrain" type="edge" tile="-1">
